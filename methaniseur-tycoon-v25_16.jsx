...
function TractorSvgInner({ isLoaded, icon, trailerTilt, isGnv }) {
  const bodyMain  = isGnv ? '#003366' : '#E8412F';
  const bodyDark  = isGnv ? '#001F40' : '#A8281F';
  const bodyAcc   = isGnv ? '#005EB8' : '#FF6A50';
  const winFill   = isGnv ? 'rgba(134,239,172,.40)' : '#A9DDFB';
  const winFrame  = isGnv ? 'var(--c-green-dark)' : '#1B2A3D';
  const tireClr   = '#2C3454';
  const tireDark  = '#1C2236';
  const rimClr    = '#E2E7EC';
  const hubClr    = '#454C68';
  return (
    <g>
      ...
      {/* Roue arrière — au premier plan, dessinée par-dessus le châssis pour rester pleinement visible */}
