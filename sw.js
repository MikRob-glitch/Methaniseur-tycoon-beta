// ─────────────────────────────────────────────────────────────────────────────
// Méthaniseur Tycoon — Service Worker v25.1
...
// ─────────────────────────────────────────────────────────────────────────────
const CACHE_NAME = 'methaniseur-tycoon-v25-22';   // v25.11.15 — Carrefours bleus → patron rouge : GNV_LANE-5 continu à R_EDGE, BOT_TOP_Y+5→R_EDGE, R_EDGE-5→BOT_TOP_Y-5, L_EDGE-5→BOT_BOT_Y-5
...
// ─── ACTIVATE ────────────────────────────────────────────────────────────────
// Supprime les anciens caches (v23-15 → v24-2 etc.)
